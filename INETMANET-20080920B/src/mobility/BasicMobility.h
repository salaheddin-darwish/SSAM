...
class INET_API BasicMobility : public BasicModule
{
  public:
     ...
     */
	int nodeIndx ; // salah
    void Registration (bool Reg);
    void SetPosition (double x, double y);
    bool isAnyNeighbourAround();
  ...
  protected:
    ...
    /** @brief Stores the actual Host state of the host*/
   std::string  hostState; // salah



    InetSimpleBattery *mBa;

    AbstractRadioExtended *R;
...
class INET_API BasicMobilityAccess : public ModuleAccess<BasicMobility>
{
  public:
      BasicMobilityAccess() : ModuleAccess<BasicMobility>("mobility") {}
};
